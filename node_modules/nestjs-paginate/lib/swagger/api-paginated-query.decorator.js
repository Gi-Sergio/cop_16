...
function Limit(paginationConfig) {
    ...
    return (0, swagger_1.ApiQuery)({
      ...
      ${p('Example', '20')}
      ${p(DEFAULT_VALUE_KEY, ((_a = paginationConfig === null || paginationConfig === void 0 ? void 0 : paginationConfig.defaultLimit) === null || _a === void 0 ? void 0 : _a.toString()) || paginate_1.DEFAULT_LIMIT.toString())}
      ${p('Max Value', ((_b = paginationConfig.maxLimit) === null || _b === void 0 ? void 0 : _b.toString()) || paginate_1.DEFAULT_MAX_LIMIT.toString())}
